...
<%@page import="com.jingpaidang.cshop.web.WebUtils"%>
<!DOCTYPE HTML>
<html lang="en-US">
<head>
    <meta charset="UTF-8">
...
<div class="body">
    <div class="errorBox">
        <div class="errorMessage">
            <b>500</b>系统出现异常了，请联系系统管理员！<br>
        </div>
        <!-- 
        <div class="errorUrl">回<a href="/">首页</a></div>
         -->
    </div>
    <dl id="detail-info">
        <dt>查看详细错误信息>></dt>
        <dd class="hidden">
           <%
    			WebUtils.printStackTrace(exception,response.getWriter());
			%>
        </dd>
    </dl>
</div>
