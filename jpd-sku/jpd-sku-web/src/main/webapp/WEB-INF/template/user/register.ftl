		...
		<div class="con-right">
			...
			<div class="reg-form">
					<table width="415" border="0" cellpadding="0" cellspacing="0" style=" margin:0 auto;">
						...
						<tr>
							<td colspan="2" style="text-align:center"><p style="float:left;padding-left:30px;"><input id="register_btn" type="image" src="/images/reg.jpg" />&nbsp;</p><p style="float:left" id="msg">我有京拍档账号，<a href="/user/loginPage">直接登录</a></p></td>
						</tr>
					</table>
			</div>
		</div>
